...
--- Factory: create a CSampler (common_sampler) from a model + options.
--- See ion7.core.sampler.common for the full constructor signature.
Sampler.common = CSampler.new
